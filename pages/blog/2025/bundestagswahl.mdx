...
<div style={{ flexDirection: "row", display: "grid", columnGap: "1rem", gridTemplateColumns:"1fr 1fr", rowGap:"0.5rem", justifyItems: "center" }} className="x:text-md">
    <div>
...
import Thueringen from "./bundestagswahl/thueringen.png";
import Sachsen from "./bundestagswahl/sachsen.png";
import Krzn from "./bundestagswahl/krzn.png";

<div className="x:grid x:grid-cols-1 x:md:grid-cols-2 x:gap-6 x:text-center">
	<div className="x:flex x:flex-col x:justify-between">
		<Image src={Votegroup} className="" alt="Wahlabwicklungssystem" style={{margin:"0"}} />
		<div>
    ...
    <div className="x:flex x:flex-col x:justify-between">
    	<Image src={Votemanager} className="" alt="VoteGroup" style={{margin:"0"}} />
    	<div>
    ...
    <div  className="x:flex x:flex-col x:items-center">
    	<Image src={MVNet} className="" alt="MVNet"  style={{margin:"0"}}/>
    	<div>
    ...
    <div  className="x:flex x:flex-col x:items-center">
    	<Image src={Krzn} className="" alt="Krzn"  style={{margin:"0"}}/>
    	<div>
    ...
    <div  className="x:flex x:flex-col x:items-center">
    	<Image src={Thueringen} className="" alt="Thüringen Wahlen" style={{margin:"0"}} />
    	<p>
    ...
    <div  className="x:flex x:flex-col x:items-center">
    	<Image src={Sachsen} className="" alt="Sachsen Wahlen" style={{margin:"0"}} />
    	<p>
...
<div style={{ maxHeight: "50vh", overflowY: "auto" }}>
	<Table>
		<thead className="x:text-md">
			<Table.Tr>
				<Table.Th>Wahlkreis</Table.Th>
				<Table.Th>Partei</Table.Th>
				<Table.Th>Bund</Table.Th>
				<Table.Th>Wahlkreis</Table.Th>
				<Table.Th>Differenz</Table.Th>
			</Table.Tr>
		</thead>
		<tbody className="x:text-sm">
			{list.map((row, i) => (
				<Table.Tr key={i}>
					<Table.Td>{row.wahlkreis}</Table.Td>
					<Table.Td>{row.partei}</Table.Td>
					<Table.Td>
						<a
...
<Table style={{float:"left",marginRight:"1rem"}}>
	...
	<tbody className="x:text-sm">
		{Object.entries(total)
			...
			.map(([partei, diff]) => (
				<Table.Tr key={partei}>
					<Table.Td style={{ padding: "0.2rem", paddingLeft: "0.5rem" }}>{partei}</Table.Td>
					<Table.Td style={{ padding: "0.2rem" }} className="x:text-center">
						{diff}
					</Table.Td>
				</Table.Tr>
			))}
    		...
    		<Table.Tr>
    			...
    			<Table.Th>{Object.values(total).reduce((a, b) => (a) + Math.abs(b), 0)}</Table.Th>
    		</Table.Tr>
    </tbody>

</Table>

Dabei sieht man, dass das BSW die höchste Diskrepanzen hat, gefolgt von der CDU und dem Bündnis Deutschland. Besonders ist dabei, dass das BSW und Bündnis Deutschland im Vergleich zu ihrer Gesamtstimmenanzahl die höchste relative Diskrepanz haben.
...
Solche menschlichen Fehler sind erwartbar bei einer Wahl mit 299 Wahlkreisen, ~675.000 Wahlhelfern und 49.927.315 abgegebenen Stimmen. Erfreulicherweise sind die Diskrepanzen sehr gering und haben keinen relevanten Einfluss auf das Wahlergebnis.
...
import Map from "./bundestagswahl/map.png";

Mithilfe der gesammelten Daten habe ich eine interaktive Wahlkarte erstellt, die die Ergebnisse für jede Gemeinde zeigt: \
[bundestagswahl.samuelscheit.com](https://bundestagswahl.samuelscheit.com/)

<Link href="https://bundestagswahl.samuelscheit.com/" target="_blank">
	<Image src={Map} style={{ height: "fit-content", margin: "0" }} />
</Link>
